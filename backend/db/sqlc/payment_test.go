...
func createRandomPayment(t *testing.T) Payment {
	...
	require.Equal(t, arg.BookingID, payment.BookingID)
...
func TestGetPayment(t *testing.T) {
	...
	p2, err := testStore.GetPayment(context.Background(), p1.PaymentID)
	require.NoError(t, err)
...
func TestDeletePayment(t *testing.T) {
	...
	err := testStore.DeletePayment(context.Background(), p.PaymentID)
	require.NoError(t, err)

	_, err = testStore.GetPayment(context.Background(), p.PaymentID)
	require.Error(t, err)
}
...
func TestListPayments(t *testing.T) {
	...
	payments, err := testStore.ListPayment(context.Background(), arg)
	require.NoError(t, err)
