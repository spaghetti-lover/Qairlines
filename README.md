...
## Cách chạy
- Thêm biến môi trường app.env vào backend
```
MAIL_FROM = <YOUR_EMAIL_ADDRESS> //Example: "phungducanh2004@gmail.com"
MAIL_PASSWORD = <YOUR_EMAIL_SECRET_CODE> //Example: "abcd zehn pbtv jvbr"
MAIL_PORT = 587
...
- Thêm biến môi trường .env vào Frontend
```
...
- B5: Chạy MAIL Server (Nếu lỗi thì chạy lại Mail Server và docker-compose do có thể Kafka chưa kịp khởi động xong)
```
make mail
```
